...
// Commented by kpr bcs of cpp 11
...
static void ns_setup_fpu()
{
	...
	static const int NS_FPU_CW = NS_FPU_CW_IC | NS_FPU_CW_RC | NS_FPU_CW_PC | NS_FPU_CW_IEM | NS_FPU_CW_B6 | NS_FPU_CW_PM | NS_FPU_CW_UM | NS_FPU_CW_OM | NS_FPU_CW_ZM | NS_FPU_CW_DM | NS_FPU_CW_IM;
...
static inline int fesetprecision(int prec)
{
	if (!(prec & ~FE_LDBLPREC) && (prec != FE_INVALIDPREC))
	{
		...
		asm volatile("fldcw %0"
					 : /* Don't push these colons together */
					 : "m"(*&cw));
		return 1;
	}
	else
