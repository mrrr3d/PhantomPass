...
typedef int seq_t; // for expressPass. expresspass defines it as int64. TODO: change to int64 (by also changing other affected files. See https://github.com/kaist-ina/ns2-xpass/compare/6759fa6..f4e38bc)
struct hdr_tcp
{
#define NSA 3
