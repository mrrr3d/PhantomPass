...
#ifndef __INET_DCTCPGENERICSRVAPP_H
#define __INET_DCTCPGENERICSRVAPP_H
 ...
 */
class INET_API DCTcpGenericServerApp : public cSimpleModule, public LifecycleUnsupported
{
protected:
  TcpSocket socket;
  simtime_t delay;
...
public:
  static simsignal_t bytesRequestedSignal;
  static simsignal_t requestReceivedSignal;
  static simsignal_t requestSourceSignal;
  static simsignal_t requestDurationSignal;
