...
class INET_API PacketQueue : public PacketQueueBase, public IPacketBuffer::ICallback
{
  ...
  protected:
    ...
    static simsignal_t queueLenBytesSampled; // whi static? (same as v2pifo)
    static simsignal_t byteDepartures;
    bool sampling_started = false;
    simtime_t q_sample_interval;
    simtime_t warmup_period; // optimisation
    long bytes_departed = 0;
