...
# ===================== General Settingss =====================
max_threads='24'
global_debug='5' # dubug level for r2p2 congestion control module
...
# ===================== R2P2 Parameters =====================
r2p2_budgets_intra_max_bytes_l='108000 108000 108000 108000'
r2p2_elet_srpb_l='72000'
r2p2_unsolicited_thresh_bytes_l="72000"
r2p2_elet_receiver_policy_l='0 0 0 4' # 0: TS among msgs, 1: fifo among senders, 2: fifo among messages 3: SRPT
r2p2_hybrid_in_network_prios_l="0"
r2p2_data_prio_l="0"
r2p2_hybrid_sender_policy_l="0"
r2p2_sender_policy_ratio_l='0'
r2p2_sender_ecn_threshold_l="25 99999 25 25"
...
# ===================== Protocols =====================
transp_prots='micro-hybrid micro-hybrid dctcp micro-hybrid'
simulation_name_l='SIRD-TS SIRD-TS-SI_OFF DCTCP SIRD-FAIR'
